      ...
      <div className="row">
        <div className="col-lg-6 mb-md-60 mb-sm-30">
          ...
          <h3 className="section-title mb-30">
            <AnimatedText text="Services We Offer" />
          </h3>
          <div className="row">
            <div className="col-lg-10">
              <p
                ...
                data-wow-delay="0.4s"
              >
                At Contraconsult, we deliver comprehensive, high-level services designed to shape public opinion, drive influence, and secure victories. Our expertise spans the entire political and PR landscape, ensuring our clients have the tools to lead with confidence.
              </p>
            </div>
          </div>
          <ul
          ...
          >
            <li role="presentation">
              <a
                ...
                data-bs-toggle="tab"
              >
                Political Campaign Management<span className="number">01</span>
              </a>
            </li>
            <li role="presentation">
              <a
                ...
                data-bs-toggle="tab"
              >
                Strategic Communications & PR<span className="number">02</span>
              </a>
            </li>
            <li role="presentation">
              <a
                ...
                data-bs-toggle="tab"
              >
                Digital Strategy & Social Media<span className="number">03</span>
              </a>
            </li>
            <li role="presentation">
              <a
                ...
                data-bs-toggle="tab"
              >
                Policy & Governance Advisory<span className="number">04</span>
              </a>
            </li>
            <li role="presentation">
              <a
                ...
                data-bs-toggle="tab"
              >
               Data-Driven Insights & Analysis<span className="number">05</span>
              </a>
            </li>
            <li role="presentation">
              <a
                ...
                data-bs-toggle="tab"
              >
                Event Management & Stakeholder Engagement<span className="number">06</span>
              </a>
            </li>
          </ul>
        </div>
